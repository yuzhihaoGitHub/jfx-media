...
package com.yuzhihao.learn.ui.view.play.controls;

import com.yuzhihao.learn.ui.view.play.controls.media.PlayPauseButton;
import com.yuzhihao.learn.ui.view.play.controls.timeline.TimelineComponent;
import com.yuzhihao.learn.ui.view.play.controls.volume.MediaPlayerVolumeControls;
...
final public class PlayerControls extends MigPane {
    ...
    public PlayerControls(Runnable onMinVolume, Runnable onMaxVolume, Consumer<Integer> onSetVolume, Runnable onPlayPause, Consumer<Float> onPlayerPositionChanged) {
        ...
        getStylesheets().add(Objects.requireNonNull(getClass().getResource(STYLESHEET)).toExternalForm());
